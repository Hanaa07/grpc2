...
class CompteServiceClient extends $grpc.Client {
  ...
  static final _$findComptesByType = $grpc.ClientMethod<$0.GetComptesByTypeRequest, $0.GetComptesByTypeResponse>(
  ...
  $grpc.ResponseFuture<$0.GetComptesByTypeResponse> findComptesByType($0.GetComptesByTypeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$findComptesByType, request, options: options);
  }
...
abstract class CompteServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.GetComptesByTypeResponse> findComptesByType_Pre($grpc.ServiceCall call, $async.Future<$0.GetComptesByTypeRequest> request) async {
    return findComptesByType(call, await request);
  }
  ...
  $async.Future<$0.GetComptesByTypeResponse> findComptesByType($grpc.ServiceCall call, $0.GetComptesByTypeRequest request);
